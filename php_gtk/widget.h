...
#define PHP_GTK_WIDGET_FE() \
    PHP_FE(gtk_widget_new,                                         arginfo_gtk_widget_new) \
    PHP_FE(gtk_widget_destroy,                                     arginfo_gtk_widget_destroy) \
    PHP_FE(gtk_widget_in_destruction,                              arginfo_gtk_widget_in_destruction) \
    PHP_FE(gtk_widget_destroyed,                                   arginfo_gtk_widget_destroyed) \
    PHP_FE(gtk_widget_unparent,                                    arginfo_gtk_widget_unparent) \
    PHP_FE(gtk_widget_show,                                        arginfo_gtk_widget_show) \
    PHP_FE(gtk_widget_show_now,                                    arginfo_gtk_widget_show_now) \
    PHP_FE(gtk_widget_hide,                                        arginfo_gtk_widget_hide) \
    PHP_FE(gtk_widget_show_all,                                    arginfo_gtk_widget_show_all) \
    PHP_FE(gtk_widget_map,                                         arginfo_gtk_widget_map) \
    PHP_FE(gtk_widget_unmap,                                       arginfo_gtk_widget_unmap) \
    PHP_FE(gtk_widget_realize,                                     arginfo_gtk_widget_realize) \
    PHP_FE(gtk_widget_unrealize,                                   arginfo_gtk_widget_unrealize) \
    PHP_FE(gtk_widget_draw,                                        arginfo_gtk_widget_draw) \
    PHP_FE(gtk_widget_queue_draw,                                  arginfo_gtk_widget_queue_draw) \
    PHP_FE(gtk_widget_queue_resize,                                arginfo_gtk_widget_queue_resize) \
    PHP_FE(gtk_widget_queue_resize_no_redraw,                      arginfo_gtk_widget_queue_resize_no_redraw) \
    PHP_FE(gtk_widget_queue_allocate,                              arginfo_gtk_widget_queue_allocate) \
    PHP_FE(gtk_widget_get_frame_clock,                             arginfo_gtk_widget_get_frame_clock) \
    PHP_FE(gtk_widget_get_scale_factor,                            arginfo_gtk_widget_get_scale_factor) \
    PHP_FE(gtk_widget_add_tick_callback,                           arginfo_gtk_widget_add_tick_callback) \
    PHP_FE(gtk_widget_remove_tick_callback,                        arginfo_gtk_widget_remove_tick_callback) \
    PHP_FE(gtk_widget_size_request,                                arginfo_gtk_widget_size_request) \
    PHP_FE(gtk_widget_get_child_requisition,                       arginfo_gtk_widget_get_child_requisition) \
    PHP_FE(gtk_widget_size_allocate,                               arginfo_gtk_widget_size_allocate) \
    PHP_FE(gtk_widget_size_allocate_with_baseline,                 arginfo_gtk_widget_size_allocate_with_baseline) \
    PHP_FE(gtk_widget_add_accelerator,                             arginfo_gtk_widget_add_accelerator) \
    PHP_FE(gtk_widget_remove_accelerator,                          arginfo_gtk_widget_remove_accelerator) \
    PHP_FE(gtk_widget_set_accel_path,                              arginfo_gtk_widget_set_accel_path) \
    PHP_FE(gtk_widget_list_accel_closures,                         arginfo_gtk_widget_list_accel_closures) \
    PHP_FE(gtk_widget_can_activate_accel,                          arginfo_gtk_widget_can_activate_accel) \
    PHP_FE(gtk_widget_event,                                       arginfo_gtk_widget_event) \
    PHP_FE(gtk_widget_activate,                                    arginfo_gtk_widget_activate) \
    PHP_FE(gtk_widget_reparent,                                    arginfo_gtk_widget_reparent) \
    PHP_FE(gtk_widget_intersect,                                   arginfo_gtk_widget_intersect) \
    PHP_FE(gtk_widget_is_focus,                                    arginfo_gtk_widget_is_focus) \
    PHP_FE(gtk_widget_grab_focus,                                  arginfo_gtk_widget_grab_focus) \
    PHP_FE(gtk_widget_grab_default,                                arginfo_gtk_widget_grab_default) \
    PHP_FE(gtk_widget_set_name,                                    arginfo_gtk_widget_set_name) \
    PHP_FE(gtk_widget_get_name,                                    arginfo_gtk_widget_get_name) \
    PHP_FE(gtk_widget_set_state,                                   arginfo_gtk_widget_set_state) \
    PHP_FE(gtk_widget_set_sensitive,                               arginfo_gtk_widget_set_sensitive) \
    PHP_FE(gtk_widget_set_parent,                                  arginfo_gtk_widget_set_parent) \
    PHP_FE(gtk_widget_set_parent_window,                           arginfo_gtk_widget_set_parent_window) \
    PHP_FE(gtk_widget_get_parent_window,                           arginfo_gtk_widget_get_parent_window) \
    PHP_FE(gtk_widget_set_events,                                  arginfo_gtk_widget_set_events) \
    PHP_FE(gtk_widget_get_events,                                  arginfo_gtk_widget_get_events) \
    PHP_FE(gtk_widget_add_events,                                  arginfo_gtk_widget_add_events) \
    PHP_FE(gtk_widget_set_device_events,                           arginfo_gtk_widget_set_device_events) \
    PHP_FE(gtk_widget_get_device_events,                           arginfo_gtk_widget_get_device_events) \
    PHP_FE(gtk_widget_add_device_events,                           arginfo_gtk_widget_add_device_events) \
    PHP_FE(gtk_widget_set_device_enabled,                          arginfo_gtk_widget_set_device_enabled) \
    PHP_FE(gtk_widget_get_device_enabled,                          arginfo_gtk_widget_get_device_enabled) \
    PHP_FE(gtk_widget_get_toplevel,                                arginfo_gtk_widget_get_toplevel) \
    PHP_FE(gtk_widget_get_ancestor,                                arginfo_gtk_widget_get_ancestor) \
    PHP_FE(gtk_widget_get_visual,                                  arginfo_gtk_widget_get_visual) \
    PHP_FE(gtk_widget_set_visual,                                  arginfo_gtk_widget_set_visual) \
    PHP_FE(gtk_widget_get_pointer,                                 arginfo_gtk_widget_get_pointer) \
    PHP_FE(gtk_widget_is_ancestor,                                 arginfo_gtk_widget_is_ancestor) \
    PHP_FE(gtk_widget_translate_coordinates,                       arginfo_gtk_widget_translate_coordinates) \
    PHP_FE(gtk_widget_hide_on_delete,                              arginfo_gtk_widget_hide_on_delete) \
    PHP_FE(gtk_widget_set_style,                                   arginfo_gtk_widget_set_style) \
    PHP_FE(gtk_widget_ensure_style,                                arginfo_gtk_widget_ensure_style) \
    PHP_FE(gtk_widget_get_style,                                   arginfo_gtk_widget_get_style) \
    PHP_FE(gtk_widget_reset_rc_styles,                             arginfo_gtk_widget_reset_rc_styles) \
    PHP_FE(gtk_widget_get_default_style,                           arginfo_gtk_widget_get_default_style) \
    PHP_FE(gtk_widget_set_direction,                               arginfo_gtk_widget_set_direction) \
    PHP_FE(gtk_widget_get_direction,                               arginfo_gtk_widget_get_direction) \
    PHP_FE(gtk_widget_set_default_direction,                       arginfo_gtk_widget_set_default_direction) \
    PHP_FE(gtk_widget_get_default_direction,                       arginfo_gtk_widget_get_default_direction) \
    PHP_FE(gtk_widget_shape_combine_region,                        arginfo_gtk_widget_shape_combine_region) \
    PHP_FE(gtk_widget_input_shape_combine_region,                  arginfo_gtk_widget_input_shape_combine_region) \
    PHP_FE(gtk_widget_path,                                        arginfo_gtk_widget_path) \
    PHP_FE(gtk_widget_class_path,                                  arginfo_gtk_widget_class_path) \
    PHP_FE(gtk_widget_get_composite_name,                          arginfo_gtk_widget_get_composite_name) \
    PHP_FE(gtk_widget_override_background_color,                   arginfo_gtk_widget_override_background_color) \
    PHP_FE(gtk_widget_override_color,                              arginfo_gtk_widget_override_color) \
    PHP_FE(gtk_widget_override_font,                               arginfo_gtk_widget_override_font) \
    PHP_FE(gtk_widget_override_symbolic_color,                     arginfo_gtk_widget_override_symbolic_color) \
    PHP_FE(gtk_widget_override_cursor,                             arginfo_gtk_widget_override_cursor) \
    PHP_FE(gtk_widget_modify_style,                                arginfo_gtk_widget_modify_style) \
    PHP_FE(gtk_widget_get_modifier_style,                          arginfo_gtk_widget_get_modifier_style) \
    PHP_FE(gtk_widget_modify_fg,                                   arginfo_gtk_widget_modify_fg) \
    PHP_FE(gtk_widget_modify_bg,                                   arginfo_gtk_widget_modify_bg) \
    PHP_FE(gtk_widget_modify_text,                                 arginfo_gtk_widget_modify_text) \
    PHP_FE(gtk_widget_modify_base,                                 arginfo_gtk_widget_modify_base) \
    PHP_FE(gtk_widget_modify_font,                                 arginfo_gtk_widget_modify_font) \
    PHP_FE(gtk_widget_modify_cursor,                               arginfo_gtk_widget_modify_cursor) \
    PHP_FE(gtk_widget_create_pango_context,                        arginfo_gtk_widget_create_pango_context) \
    PHP_FE(gtk_widget_get_pango_context,                           arginfo_gtk_widget_get_pango_context) \
    PHP_FE(gtk_widget_set_font_options,                            arginfo_gtk_widget_set_font_options) \
    PHP_FE(gtk_widget_get_font_options,                            arginfo_gtk_widget_get_font_options) \
    PHP_FE(gtk_widget_set_font_map,                                arginfo_gtk_widget_set_font_map) \
    PHP_FE(gtk_widget_get_font_map,                                arginfo_gtk_widget_get_font_map) \
    PHP_FE(gtk_widget_create_pango_layout,                         arginfo_gtk_widget_create_pango_layout) \
    PHP_FE(gtk_widget_render_icon,                                 arginfo_gtk_widget_render_icon) \
    PHP_FE(gtk_widget_render_icon_pixbuf,                          arginfo_gtk_widget_render_icon_pixbuf) \
    PHP_FE(gtk_widget_pop_composite_child,                         arginfo_gtk_widget_pop_composite_child) \
    PHP_FE(gtk_widget_push_composite_child,                        arginfo_gtk_widget_push_composite_child) \
    PHP_FE(gtk_widget_queue_draw_area,                             arginfo_gtk_widget_queue_draw_area) \
    PHP_FE(gtk_widget_queue_draw_region,                           arginfo_gtk_widget_queue_draw_region) \
    PHP_FE(gtk_widget_set_app_paintable,                           arginfo_gtk_widget_set_app_paintable) \
    PHP_FE(gtk_widget_set_double_buffered,                         arginfo_gtk_widget_set_double_buffered) \
    PHP_FE(gtk_widget_set_redraw_on_allocate,                      arginfo_gtk_widget_set_redraw_on_allocate) \
    PHP_FE(gtk_widget_set_composite_name,                          arginfo_gtk_widget_set_composite_name) \
    PHP_FE(gtk_widget_mnemonic_activate,                           arginfo_gtk_widget_mnemonic_activate) \
    PHP_FE(gtk_widget_class_install_style_property,                arginfo_gtk_widget_class_install_style_property) \
    PHP_FE(gtk_widget_class_install_style_property_parser,         arginfo_gtk_widget_class_install_style_property_parser) \
    PHP_FE(gtk_widget_class_find_style_property,                   arginfo_gtk_widget_class_find_style_property) \
    PHP_FE(gtk_widget_class_list_style_properties,                 arginfo_gtk_widget_class_list_style_properties) \
    PHP_FE(gtk_widget_region_intersect,                            arginfo_gtk_widget_region_intersect) \
    PHP_FE(gtk_widget_send_expose,                                 arginfo_gtk_widget_send_expose) \
    PHP_FE(gtk_widget_send_focus_change,                           arginfo_gtk_widget_send_focus_change) \
    PHP_FE(gtk_widget_style_get,                                   arginfo_gtk_widget_style_get) \
    PHP_FE(gtk_widget_style_get_property,                          arginfo_gtk_widget_style_get_property) \
    PHP_FE(gtk_widget_style_get_valist,                            arginfo_gtk_widget_style_get_valist) \
    PHP_FE(gtk_widget_style_attach,                                arginfo_gtk_widget_style_attach) \
    PHP_FE(gtk_widget_class_set_accessible_type,                   arginfo_gtk_widget_class_set_accessible_type) \
    PHP_FE(gtk_widget_class_set_accessible_role,                   arginfo_gtk_widget_class_set_accessible_role) \
    PHP_FE(gtk_widget_get_accessible,                              arginfo_gtk_widget_get_accessible) \
    PHP_FE(gtk_widget_child_focus,                                 arginfo_gtk_widget_child_focus) \
    PHP_FE(gtk_widget_child_notify,                                arginfo_gtk_widget_child_notify) \
    PHP_FE(gtk_widget_freeze_child_notify,                         arginfo_gtk_widget_freeze_child_notify) \
    PHP_FE(gtk_widget_get_child_visible,                           arginfo_gtk_widget_get_child_visible) \
    PHP_FE(gtk_widget_get_parent,                                  arginfo_gtk_widget_get_parent) \
    PHP_FE(gtk_widget_get_settings,                                arginfo_gtk_widget_get_settings) \
    PHP_FE(gtk_widget_get_clipboard,                               arginfo_gtk_widget_get_clipboard) \
    PHP_FE(gtk_widget_get_display,                                 arginfo_gtk_widget_get_display) \
    PHP_FE(gtk_widget_get_root_window,                             arginfo_gtk_widget_get_root_window) \
    PHP_FE(gtk_widget_get_screen,                                  arginfo_gtk_widget_get_screen) \
    PHP_FE(gtk_widget_has_screen,                                  arginfo_gtk_widget_has_screen) \
    PHP_FE(gtk_widget_get_size_request,                            arginfo_gtk_widget_get_size_request) \
    PHP_FE(gtk_widget_set_child_visible,                           arginfo_gtk_widget_set_child_visible) \
    PHP_FE(gtk_widget_set_size_request,                            arginfo_gtk_widget_set_size_request) \
    PHP_FE(gtk_widget_thaw_child_notify,                           arginfo_gtk_widget_thaw_child_notify) \
    PHP_FE(gtk_widget_set_no_show_all,                             arginfo_gtk_widget_set_no_show_all) \
    PHP_FE(gtk_widget_get_no_show_all,                             arginfo_gtk_widget_get_no_show_all) \
    PHP_FE(gtk_widget_list_mnemonic_labels,                        arginfo_gtk_widget_list_mnemonic_labels) \
    PHP_FE(gtk_widget_add_mnemonic_label,                          arginfo_gtk_widget_add_mnemonic_label) \
    PHP_FE(gtk_widget_remove_mnemonic_label,                       arginfo_gtk_widget_remove_mnemonic_label) \
    PHP_FE(gtk_widget_is_composited,                               arginfo_gtk_widget_is_composited) \
    PHP_FE(gtk_widget_error_bell,                                  arginfo_gtk_widget_error_bell) \
    PHP_FE(gtk_widget_keynav_failed,                               arginfo_gtk_widget_keynav_failed) \
    PHP_FE(gtk_widget_get_tooltip_markup,                          arginfo_gtk_widget_get_tooltip_markup) \
    PHP_FE(gtk_widget_set_tooltip_markup,                          arginfo_gtk_widget_set_tooltip_markup) \
    PHP_FE(gtk_widget_get_tooltip_text,                            arginfo_gtk_widget_get_tooltip_text) \
    PHP_FE(gtk_widget_set_tooltip_text,                            arginfo_gtk_widget_set_tooltip_text) \
    PHP_FE(gtk_widget_get_tooltip_window,                          arginfo_gtk_widget_get_tooltip_window) \
    PHP_FE(gtk_widget_set_tooltip_window,                          arginfo_gtk_widget_set_tooltip_window) \
    PHP_FE(gtk_widget_get_has_tooltip,                             arginfo_gtk_widget_get_has_tooltip) \
    PHP_FE(gtk_widget_set_has_tooltip,                             arginfo_gtk_widget_set_has_tooltip) \
    PHP_FE(gtk_widget_trigger_tooltip_query,                       arginfo_gtk_widget_trigger_tooltip_query) \
    PHP_FE(gtk_widget_get_window,                                  arginfo_gtk_widget_get_window) \
    PHP_FE(gtk_widget_register_window,                             arginfo_gtk_widget_register_window) \
    PHP_FE(gtk_widget_unregister_window,                           arginfo_gtk_widget_unregister_window) \
    PHP_FE(gtk_cairo_should_draw_window,                           arginfo_gtk_cairo_should_draw_window) \
    PHP_FE(gtk_cairo_transform_to_window,                          arginfo_gtk_cairo_transform_to_window) \
    PHP_FE(gtk_widget_get_allocated_width,                         arginfo_gtk_widget_get_allocated_width) \
    PHP_FE(gtk_widget_get_allocated_height,                        arginfo_gtk_widget_get_allocated_height) \
    PHP_FE(gtk_widget_get_allocation,                              arginfo_gtk_widget_get_allocation) \
    PHP_FE(gtk_widget_set_allocation,                              arginfo_gtk_widget_set_allocation) \
    PHP_FE(gtk_widget_get_allocated_baseline,                      arginfo_gtk_widget_get_allocated_baseline) \
    PHP_FE(gtk_widget_get_allocated_size,                          arginfo_gtk_widget_get_allocated_size) \
    PHP_FE(gtk_widget_get_clip,                                    arginfo_gtk_widget_get_clip) \
    PHP_FE(gtk_widget_set_clip,                                    arginfo_gtk_widget_set_clip) \
    PHP_FE(gtk_widget_get_app_paintable,                           arginfo_gtk_widget_get_app_paintable) \
    PHP_FE(gtk_widget_get_can_default,                             arginfo_gtk_widget_get_can_default) \
    PHP_FE(gtk_widget_set_can_default,                             arginfo_gtk_widget_set_can_default) \
    PHP_FE(gtk_widget_get_can_focus,                               arginfo_gtk_widget_get_can_focus) \
    PHP_FE(gtk_widget_set_can_focus,                               arginfo_gtk_widget_set_can_focus) \
    PHP_FE(gtk_widget_get_focus_on_click,                          arginfo_gtk_widget_get_focus_on_click) \
    PHP_FE(gtk_widget_set_focus_on_click,                          arginfo_gtk_widget_set_focus_on_click) \
    PHP_FE(gtk_widget_get_double_buffered,                         arginfo_gtk_widget_get_double_buffered) \
    PHP_FE(gtk_widget_get_has_window,                              arginfo_gtk_widget_get_has_window) \
    PHP_FE(gtk_widget_set_has_window,                              arginfo_gtk_widget_set_has_window) \
    PHP_FE(gtk_widget_get_sensitive,                               arginfo_gtk_widget_get_sensitive) \
    PHP_FE(gtk_widget_is_sensitive,                                arginfo_gtk_widget_is_sensitive) \
    PHP_FE(gtk_widget_get_state,                                   arginfo_gtk_widget_get_state) \
    PHP_FE(gtk_widget_get_visible,                                 arginfo_gtk_widget_get_visible) \
    PHP_FE(gtk_widget_is_visible,                                  arginfo_gtk_widget_is_visible) \
    PHP_FE(gtk_widget_set_visible,                                 arginfo_gtk_widget_set_visible) \
    PHP_FE(gtk_widget_set_state_flags,                             arginfo_gtk_widget_set_state_flags) \
    PHP_FE(gtk_widget_unset_state_flags,                           arginfo_gtk_widget_unset_state_flags) \
    PHP_FE(gtk_widget_get_state_flags,                             arginfo_gtk_widget_get_state_flags) \
    PHP_FE(gtk_widget_has_default,                                 arginfo_gtk_widget_has_default) \
    PHP_FE(gtk_widget_has_focus,                                   arginfo_gtk_widget_has_focus) \
    PHP_FE(gtk_widget_has_visible_focus,                           arginfo_gtk_widget_has_visible_focus) \
    PHP_FE(gtk_widget_has_grab,                                    arginfo_gtk_widget_has_grab) \
    PHP_FE(gtk_widget_has_rc_style,                                arginfo_gtk_widget_has_rc_style) \
    PHP_FE(gtk_widget_is_drawable,                                 arginfo_gtk_widget_is_drawable) \
    PHP_FE(gtk_widget_is_toplevel,                                 arginfo_gtk_widget_is_toplevel) \
    PHP_FE(gtk_widget_set_window,                                  arginfo_gtk_widget_set_window) \
    PHP_FE(gtk_widget_set_receives_default,                        arginfo_gtk_widget_set_receives_default) \
    PHP_FE(gtk_widget_get_receives_default,                        arginfo_gtk_widget_get_receives_default) \
    PHP_FE(gtk_widget_set_support_multidevice,                     arginfo_gtk_widget_set_support_multidevice) \
    PHP_FE(gtk_widget_get_support_multidevice,                     arginfo_gtk_widget_get_support_multidevice) \
    PHP_FE(gtk_widget_set_realized,                                arginfo_gtk_widget_set_realized) \
    PHP_FE(gtk_widget_get_realized,                                arginfo_gtk_widget_get_realized) \
    PHP_FE(gtk_widget_set_mapped,                                  arginfo_gtk_widget_set_mapped) \
    PHP_FE(gtk_widget_get_mapped,                                  arginfo_gtk_widget_get_mapped) \
    PHP_FE(gtk_widget_get_requisition,                             arginfo_gtk_widget_get_requisition) \
    PHP_FE(gtk_widget_device_is_shadowed,                          arginfo_gtk_widget_device_is_shadowed) \
    PHP_FE(gtk_widget_get_modifier_mask,                           arginfo_gtk_widget_get_modifier_mask) \
    PHP_FE(gtk_widget_insert_action_group,                         arginfo_gtk_widget_insert_action_group) \
    PHP_FE(gtk_widget_get_opacity,                                 arginfo_gtk_widget_get_opacity) \
    PHP_FE(gtk_widget_set_opacity,                                 arginfo_gtk_widget_set_opacity) \
    PHP_FE(gtk_widget_list_action_prefixes,                        arginfo_gtk_widget_list_action_prefixes) \
    PHP_FE(gtk_widget_get_action_group,                            arginfo_gtk_widget_get_action_group) \
    PHP_FE(gtk_widget_get_path,                                    arginfo_gtk_widget_get_path) \
    PHP_FE(gtk_widget_get_style_context,                           arginfo_gtk_widget_get_style_context) \
    PHP_FE(gtk_widget_reset_style,                                 arginfo_gtk_widget_reset_style) \
    PHP_FE(gtk_widget_class_get_css_name,                          arginfo_gtk_widget_class_get_css_name) \
    PHP_FE(gtk_widget_class_set_css_name,                          arginfo_gtk_widget_class_set_css_name) \
    PHP_FE(gtk_requisition_new,                                    arginfo_gtk_requisition_new) \
    PHP_FE(gtk_requisition_copy,                                   arginfo_gtk_requisition_copy) \
    PHP_FE(gtk_requisition_free,                                   arginfo_gtk_requisition_free) \
    PHP_FE(gtk_widget_get_preferred_height,                        arginfo_gtk_widget_get_preferred_height) \
    PHP_FE(gtk_widget_get_preferred_width,                         arginfo_gtk_widget_get_preferred_width) \
    PHP_FE(gtk_widget_get_preferred_height_for_width,              arginfo_gtk_widget_get_preferred_height_for_width) \
    PHP_FE(gtk_widget_get_preferred_width_for_height,              arginfo_gtk_widget_get_preferred_width_for_height) \
    PHP_FE(gtk_widget_get_preferred_height_and_baseline_for_width, arginfo_gtk_widget_get_preferred_height_and_baseline_for_width) \
    PHP_FE(gtk_widget_get_request_mode,                            arginfo_gtk_widget_get_request_mode) \
    PHP_FE(gtk_widget_get_preferred_size,                          arginfo_gtk_widget_get_preferred_size) \
    PHP_FE(gtk_distribute_natural_allocation,                      arginfo_gtk_distribute_natural_allocation) \
    PHP_FE(gtk_widget_get_halign,                                  arginfo_gtk_widget_get_halign) \
    PHP_FE(gtk_widget_set_halign,                                  arginfo_gtk_widget_set_halign) \
    PHP_FE(gtk_widget_get_valign,                                  arginfo_gtk_widget_get_valign) \
    PHP_FE(gtk_widget_get_valign_with_baseline,                    arginfo_gtk_widget_get_valign_with_baseline) \
    PHP_FE(gtk_widget_set_valign,                                  arginfo_gtk_widget_set_valign) \
    PHP_FE(gtk_widget_get_margin_left,                             arginfo_gtk_widget_get_margin_left) \
    PHP_FE(gtk_widget_set_margin_left,                             arginfo_gtk_widget_set_margin_left) \
    PHP_FE(gtk_widget_get_margin_right,                            arginfo_gtk_widget_get_margin_right) \
    PHP_FE(gtk_widget_set_margin_right,                            arginfo_gtk_widget_set_margin_right) \
    PHP_FE(gtk_widget_get_margin_start,                            arginfo_gtk_widget_get_margin_start) \
    PHP_FE(gtk_widget_set_margin_start,                            arginfo_gtk_widget_set_margin_start) \
    PHP_FE(gtk_widget_get_margin_end,                              arginfo_gtk_widget_get_margin_end) \
    PHP_FE(gtk_widget_set_margin_end,                              arginfo_gtk_widget_set_margin_end) \
    PHP_FE(gtk_widget_get_margin_top,                              arginfo_gtk_widget_get_margin_top) \
    PHP_FE(gtk_widget_set_margin_top,                              arginfo_gtk_widget_set_margin_top) \
    PHP_FE(gtk_widget_get_margin_bottom,                           arginfo_gtk_widget_get_margin_bottom) \
    PHP_FE(gtk_widget_set_margin_bottom,                           arginfo_gtk_widget_set_margin_bottom) \
    PHP_FE(gtk_widget_get_hexpand,                                 arginfo_gtk_widget_get_hexpand) \
    PHP_FE(gtk_widget_set_hexpand,                                 arginfo_gtk_widget_set_hexpand) \
    PHP_FE(gtk_widget_get_hexpand_set,                             arginfo_gtk_widget_get_hexpand_set) \
    PHP_FE(gtk_widget_set_hexpand_set,                             arginfo_gtk_widget_set_hexpand_set) \
    PHP_FE(gtk_widget_get_vexpand,                                 arginfo_gtk_widget_get_vexpand) \
    PHP_FE(gtk_widget_set_vexpand,                                 arginfo_gtk_widget_set_vexpand) \
    PHP_FE(gtk_widget_get_vexpand_set,                             arginfo_gtk_widget_get_vexpand_set) \
    PHP_FE(gtk_widget_set_vexpand_set,                             arginfo_gtk_widget_set_vexpand_set) \
    PHP_FE(gtk_widget_queue_compute_expand,                        arginfo_gtk_widget_queue_compute_expand) \
    PHP_FE(gtk_widget_compute_expand,                              arginfo_gtk_widget_compute_expand) \
    PHP_FE(gtk_widget_init_template,                               arginfo_gtk_widget_init_template) \
    PHP_FE(gtk_widget_class_set_template,                          arginfo_gtk_widget_class_set_template) \
    PHP_FE(gtk_widget_class_set_template_from_resource,            arginfo_gtk_widget_class_set_template_from_resource) \
    PHP_FE(gtk_widget_get_template_child,                          arginfo_gtk_widget_get_template_child) \
    PHP_FE(gtk_widget_class_bind_template_child_full,              arginfo_gtk_widget_class_bind_template_child_full) \
    PHP_FE(gtk_widget_class_bind_template_callback_full,           arginfo_gtk_widget_class_bind_template_callback_full) \
    PHP_FE(gtk_widget_class_set_connect_func,                      arginfo_gtk_widget_class_set_connect_func) \
