...
#define PHP_CAIRO_SURFACE_T_FE() \
    PHP_FE(cairo_surface_create_similar,          arginfo_cairo_surface_create_similar) \
    PHP_FE(cairo_surface_create_similar_image,    arginfo_cairo_surface_create_similar_image) \
    PHP_FE(cairo_surface_create_for_rectangle,    arginfo_cairo_surface_create_for_rectangle) \
    PHP_FE(cairo_surface_reference,               arginfo_cairo_surface_reference) \
    PHP_FE(cairo_surface_destroy,                 arginfo_cairo_surface_destroy) \
    PHP_FE(cairo_surface_status,                  arginfo_cairo_surface_status) \
    PHP_FE(cairo_surface_finish,                  arginfo_cairo_surface_finish) \
    PHP_FE(cairo_surface_flush,                   arginfo_cairo_surface_flush) \
    PHP_FE(cairo_surface_get_device,              arginfo_cairo_surface_get_device) \
    PHP_FE(cairo_surface_get_font_options,        arginfo_cairo_surface_get_font_options) \
    PHP_FE(cairo_surface_get_content,             arginfo_cairo_surface_get_content) \
    PHP_FE(cairo_surface_mark_dirty,              arginfo_cairo_surface_mark_dirty) \
    PHP_FE(cairo_surface_mark_dirty_rectangle,    arginfo_cairo_surface_mark_dirty_rectangle) \
    PHP_FE(cairo_surface_set_device_offset,       arginfo_cairo_surface_set_device_offset) \
    PHP_FE(cairo_surface_get_device_offset,       arginfo_cairo_surface_get_device_offset) \
    PHP_FE(cairo_surface_get_device_scale,        arginfo_cairo_surface_get_device_scale) \
    PHP_FE(cairo_surface_set_device_scale,        arginfo_cairo_surface_set_device_scale) \
    PHP_FE(cairo_surface_set_fallback_resolution, arginfo_cairo_surface_set_fallback_resolution) \
    PHP_FE(cairo_surface_get_fallback_resolution, arginfo_cairo_surface_get_fallback_resolution) \
    PHP_FE(cairo_surface_get_type,                arginfo_cairo_surface_get_type) \
    PHP_FE(cairo_surface_get_reference_count,     arginfo_cairo_surface_get_reference_count) \
    PHP_FE(cairo_surface_set_user_data,           arginfo_cairo_surface_set_user_data) \
    PHP_FE(cairo_surface_get_user_data,           arginfo_cairo_surface_get_user_data) \
    PHP_FE(cairo_surface_copy_page,               arginfo_cairo_surface_copy_page) \
    PHP_FE(cairo_surface_show_page,               arginfo_cairo_surface_show_page) \
    PHP_FE(cairo_surface_has_show_text_glyphs,    arginfo_cairo_surface_has_show_text_glyphs) \
    PHP_FE(cairo_surface_set_mime_data,           arginfo_cairo_surface_set_mime_data) \
    PHP_FE(cairo_surface_get_mime_data,           arginfo_cairo_surface_get_mime_data) \
    PHP_FE(cairo_surface_supports_mime_type,      arginfo_cairo_surface_supports_mime_type) \
    PHP_FE(cairo_surface_map_to_image,            arginfo_cairo_surface_map_to_image) \
    PHP_FE(cairo_surface_unmap_image,             arginfo_cairo_surface_unmap_image) \
